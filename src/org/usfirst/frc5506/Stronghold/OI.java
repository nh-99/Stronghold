...
public class OI {
    ...
    public OI() {
        ...
        SmartDashboard.putData("DriveToCourtyard", new DriveToCourtyard());
        ...
        SmartDashboard.putData("ContractArm", new ContractArm());

    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        
        Button shoot = new JoystickButton(functionJoystick, 8);
        shoot.whenPressed(new Shoot());
        
        Button scaleUp = new JoystickButton(functionJoystick, 1);
        Button scaleDown = new JoystickButton(functionJoystick, 2);
        scaleUp.whenPressed(new ExtendArm(false));
        scaleUp.whenReleased(new ExtendArm(true));
        scaleDown.whenPressed(new ContractArm(false));
        scaleDown.whenReleased(new ContractArm(true));
    }
