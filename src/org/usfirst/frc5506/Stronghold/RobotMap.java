...
public class RobotMap {
    ...
    public static CANTalon launcherlaunchingMotor;
    ...
    public static void init() {
        ...
        loadermotor = new TalonSRX(4);
        LiveWindow.addActuator("Loader", "motor", (TalonSRX) loadermotor);
        
        launcherlaunchingMotor = new CANTalon(0);
        LiveWindow.addActuator("Launcher", "launchingMotor", launcherlaunchingMotor);
        
        launcherreleaseMotor = new Talon(2);
        LiveWindow.addActuator("Launcher", "releaseMotor", (Talon) launcherreleaseMotor);
