...
public class OI {
    ...
    public OI() {
        ...
        liftDownButton = new JoystickButton(joystick0, 1);
        liftDownButton.whenReleased(new LiftDown(0));
        liftUpButton = new JoystickButton(joystick0, 1);
        liftUpButton.whileHeld(new LiftUp(0));
